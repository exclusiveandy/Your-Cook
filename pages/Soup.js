...
import souptop from './images/top/souptop.png'

import bulalo from './images/soup/bulalo.png'
import nilaga from './images/soup/nilaga.png'
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalVisible} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          ...
          <View style={styles.modal}>
            ...
            <Image source={soup} style={styles.btncss} />
...
{"\n\n\n"}
        ...
        <TouchableOpacity style={styles.btnStew} onPress={() => { this.setModalVisible(true); }}>
          <Image source={souptop}/>
        </TouchableOpacity>

        <ScrollView >

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Bulalo')}>
            <Image source={bulalo} style={styles.btnBord}/>
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Nilaga')}>
            <Image source={nilaga} style={styles.btnBord}/>
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Tinola')}>
