...
import vegietop from './images/top/vegietop.png'
...
export default class Vegie extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalVisible} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          ...
          <View style={styles.modal}>
            ...
            <Image source={vegie} style={styles.btncss} />
...
{"\n\n\n"}
        ...
        <TouchableOpacity style={styles.btnStew} onPress={() => { this.setModalVisible(true); }}>
          <Image source={vegietop} />
        </TouchableOpacity>

        <ScrollView >

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Monggo')}>
            <Image source={monggo} style={styles.btnBord}/>
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Pinakbet')}>
            <Image source={pinakbet} style={styles.btnBord}/>
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Chopsuey')}>
          <Image source={chopsuey} style={styles.btnBord}/>
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Ampalaya')}>
