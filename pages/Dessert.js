...
import { Modal, Alert, TouchableOpacity, StyleSheet, ImageBackground, Image, Animated, Text, View, ScrollView } from 'react-native';



import backimg from './images/yourcookback.jpg'

import desserttop from './images/top/desserttop.png'
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalVisible} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          ...
          <View style={styles.modal}>
            ...
            <Image source={dessert} style={styles.btncss} />
        ...
        <TouchableOpacity style={styles.btnStew} onPress={() => { this.setModalVisible(true); }}>
          <Image source={desserttop} />
        </TouchableOpacity>

        <ScrollView >

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('HaloHalo')}>
            <Image source={halohalo} style={styles.btnBord} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Biko')}>
            <Image source={biko} style={styles.btnBord} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Leche')}>
            <Image source={leche} style={styles.btnBord} />
          </TouchableOpacity>

          <TouchableOpacity style={styles.btnDishes} onPress={() => this.props.navigation.navigate('Maja')}>
