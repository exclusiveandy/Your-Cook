...
import bulalo from '../../images/soup/bulalo.png'
...
export default class Bulalo extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <View style={{ marginTop: 20, }}>
          <TouchableOpacity onPress={this.modalfacts}>
            <Image source={bulalo} style={styles.btnBord} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Cook Time{"\t\t"}- 1hr 50mins</Text>
          </View>

          <View style={styles.row}>
            <Image source={total} style={styles.imgDesc} />
            <Text style={styles.textDesc}>Total Time{"\t\t"}- 2 Hours</Text>
          </View>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 2 lbs beef shank</Text>
            <Text style={styles.ingredients}>• ½ pc small cabbage whole leaf individually detached</Text>
            <Text style={styles.ingredients}>• 1 small bundle Pechay</Text>
            <Text style={styles.ingredients}>• 3 pcs Corn each cut into 3 parts</Text>
            <Text style={styles.ingredients}>• 2 tbsp Whole pepper corn</Text>
            <Text style={styles.ingredients}>• 1/2 cup Green onions</Text>
            <Text style={styles.ingredients}>• 1 medium sized onion</Text>
            <Text style={styles.ingredients}>• 34 ounces water</Text>
            <Text style={styles.ingredients}>• 2 tbsp fish sauce optional</Text>
          </View>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. In a big cooking pot, pour in water and bring to a boil</Text>
            <Text style={styles.ingredients}>2. Put-in the beef shank followed by the onion and whole pepper corn then simmer for 1.5 hours (30 mins if using a pressure cooker) or until meat is tender.</Text>
            <Text style={styles.ingredients}>3. Add the corn and simmer for another 10 minutes</Text>
            <Text style={styles.ingredients}>4. Add the fish sauce,cabbage, pechay, and green onion (onion leeks)</Text>
