...
import tinola from '../../images/soup/tinola.png'
...
export default class Tinola extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <View style={{ marginTop: 20, }}>
          <TouchableOpacity onPress={this.modalfacts}>
            <Image source={tinola} style={styles.btnBord} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 1 whole chicken cut into serving pieces</Text>
            <Text style={styles.ingredients}>• 36 ounces rice washing</Text>
            <Text style={styles.ingredients}>• 1/2 piece green papaya cut into wedges</Text>
            <Text style={styles.ingredients}>• 1 tablespoon garlic minced</Text>
            <Text style={styles.ingredients}>• 1 piece onion chopped</Text>
            <Text style={styles.ingredients}>• 1 thumb ginger cut into strips</Text>
            <Text style={styles.ingredients}>• 2 tablespoon fish sauce</Text>
            <Text style={styles.ingredients}>• 1 cup Hot pepper leaves</Text>            
            <Text style={styles.ingredients}>• 3 tablespoons fish sauce</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. Sauté the garlic, onion, and ginger</Text>
            <Text style={styles.ingredients}>2. Put-in the chicken and cook until color turns light brown</Text>
            <Text style={styles.ingredients}>3. Add the fish sauce. Stir. Pour rice washing into the cooking pot. Let boil. Cover the pot and simmer for 45 minutes. Note: add water if needed.</Text>
            <Text style={styles.ingredients}>4. Add green papaya. Cook for 5 minutes</Text>
            <Text style={styles.ingredients}>5. Add the hot pepper leaves or malunggay leaves. Stir and cook for 1 minute.</Text>
            <Text style={styles.ingredients}>6. Season with ground black pepper. Note you can also add fish sauce or salt if needed. Serve!</Text>
