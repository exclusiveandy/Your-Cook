...
import biko from '../../images/dessert/biko.png'
...
export default class Biko extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <View style={{ marginTop: 20, }}>
          <TouchableOpacity onPress={this.modalfacts}>
            <Image source={biko} style={styles.btnBord} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Cook Time{"\t\t"}- 40 Minutes</Text>
          </View>

          <View style={styles.row}>
            <Image source={total} style={styles.imgDesc} />
            <Text style={styles.textDesc}>Total Time{"\t\t"}- 50 Minutes</Text>
          </View>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 2 cups glutinous rice aka sticky rice or malagkit</Text>
            <Text style={styles.ingredients}>• 1 1/2 cups water</Text>
            <Text style={styles.ingredients}>• 2 cups brown sugar</Text>
            <Text style={styles.ingredients}>• 4 cups coconut milk</Text>
            <Text style={styles.ingredients}>• 1/2 tsp salt</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. Combine the sticky rice and water in a rice cooker and cook until the rice is ready (we intentionally combined lesser amount of water than the usual so that the rice will not be fully cooked)</Text>
            <Text style={styles.ingredients}>2. While the rice is cooking, combine the coconut milk with brown sugar and salt in a separate pot and cook in low heat until the texture becomes thick. Stir constantly.</Text>
            <Text style={styles.ingredients}>3. Once the rice is cooked and the coconut milk-sugar mixture is thick enough, add the cooked rice in the coconut milk and sugar mixture then mix well. Continue cooking until all the liquid evaporates (but do not overcook).</Text>
            <Text style={styles.ingredients}>4. Scoop the cooked biko and place it in a serving plate then flatten the surface.</Text>
