...
import maja from '../../images/dessert/maja.png'
...
export default class Maja extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalFact} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          <View style={styles.modal}>
            <View style={{ position: 'absolute', top: 30, }}>
              ...
              <Text> {"\n"}</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Calories: 574 kcal</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Carbohydrates: 68g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Protein: 8g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Sodium: 176mg</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Potassium: 541mg</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Sugar: 47g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Vitamin A: 3.4%</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Vitamin C: 4%</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Calcium: 18.7%</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Iron: 22.8%</Text>

              <Text> {"\n"}</Text>

              <Text style={{ fontSize: 20, color: 'black', fontWeight: 'bold' }}> Estimated Cost</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> 220 php+</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Good for 8 person(s)</Text>
        ...
        <View style={{ marginTop: 20, }}>
          <TouchableOpacity onPress={this.modalfacts}>
            <Image source={maja} style={styles.btnBord} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Prep Time{"\t\t"}- 8 Minutes</Text>
          </View>

          <View style={styles.row}>
            <Image source={cook} style={styles.imgDesc} />
            <Text style={styles.textDesc}>Cook Time{"\t\t"}- 35 Minutes</Text>
          </View>

          <View style={styles.row}>
            <Image source={total} style={styles.imgDesc} />
            <Text style={styles.textDesc}>Total Time{"\t\t"}- 43 Minutes</Text>
          </View>

          <View style={styles.row}>
            <Image source={servings} style={styles.imgDesc} />
            <Text style={styles.textDesc}>Servings{"\t\t\t"}- 8 People</Text>
          </View>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 4 cups coconut milk</Text>
            <Text style={styles.ingredients}>• 3/4 cup cornstarch</Text>
            <Text style={styles.ingredients}>• 14 ounces condensed milk</Text>
            <Text style={styles.ingredients}>• 3/4 cup fresh milk</Text>
            <Text style={styles.ingredients}>• 3/4 cup granulated sugar</Text>
            <Text style={styles.ingredients}>• 15 ounces whole sweet kernel corn</Text>
            <Text style={styles.ingredients}>• 5 tbsp toasted grated coconut</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. Pour the coconut milk in a cooking pot and bring to a boil.</Text>
            <Text style={styles.ingredients}>2. Add the sugar, condensed milk, and whole sweet kernel corn then stir until all the ingredients are evenly distributed then simmer for 8 minutes</Text>
            <Text style={styles.ingredients}>3. Combine the milk and cornstarch then whisk until the cornstarch is diluted then Pour the fresh milk and cornstarch mixture in the cooking pot and stir thoroughly.</Text>
            <Text style={styles.ingredients}>4. Allow to cook while stirring until the mixture reaches your desired thickness</Text>
            <Text style={styles.ingredients}>5. Pour the mixture in a serving tray then arrange and flatten the top using a flat tool such as a wooden spatula</Text>
            <Text style={styles.ingredients}>6. Allow to cool down then refrigerate for at least 1 hour</Text>
            <Text style={styles.ingredients}>7. Garnish with toasted grated coconut (or latik if available)</Text>
          </View>
          ...
          <View style={styles.modal}>
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                Add the sugar, condensed milk, and whole sweet kernel corn then stir until all the ingredients are evenly distributed then simmer for 8 minutes
                </Text>
          ...
          <View style={styles.modal}>
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Text style={{ textAlign: 'center', flexWrap: 'wrap', alignSelf: 'center', fontSize: 18, marginBottom: 120, color: 'black'}}>
                Combine the milk and cornstarch then whisk until the cornstarch is diluted then Pour the fresh milk and cornstarch mixture in the cooking pot and stir thoroughly.
                </Text>
