...
export default class BicolExpress extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Servings{"\t\t\t"}- 4-6 People</Text>
          </View>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 3 cups coconut milk</Text>
            <Text style={styles.ingredients}>• 2 lbs pork belly cut into strips</Text>
            <Text style={styles.ingredients}>• 1/2 cup Shrimp Paste</Text>
            <Text style={styles.ingredients}>• 1 tbsp Garlic minced</Text>
            <Text style={styles.ingredients}>• 6 pieces Thai chili or Serrano pepper</Text>
            <Text style={styles.ingredients}>• 3 tablespoons minced ginger</Text>
            <Text style={styles.ingredients}>• 1 piece onion minced</Text>
            <Text style={styles.ingredients}>• 2 tablespoons cooking oil</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. Heat a pan and then pour-in the cooking oil.</Text>
            <Text style={styles.ingredients}>2. Sauté the garlic, onion, and ginger</Text>
            <Text style={styles.ingredients}>3. Add the pork and then continue cooking for 5 to 7 minutes or until the color becomes light brown</Text>
            <Text style={styles.ingredients}>4. Put-in the shrimp paste and Thai chili or Serrano pepper. Stir.</Text>
            <Text style={styles.ingredients}>5. Pour the coconut milk in. Bring to a boil. Simmer for 40 minutes or until the pork is tender</Text>
            <Text style={styles.ingredients}>6. Add salt and ground black pepper to taste. Serve!</Text>
            ...
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Text style={{ textAlign: 'center', flexWrap: 'wrap', alignSelf: 'center', fontSize: 18, marginBottom: 120, color: 'black'}}>
                 MINCED / SLICE PORK BELLY, GARLIC & ONION
                </Text>
