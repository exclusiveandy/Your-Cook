...
export default class Adobo extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Prep Time{"\t\t"}- 1 Hour+</Text>
          </View>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Total Time{"\t\t"}- 2 Hour+</Text>
          </View>
          ...
          <Text style={styles.ingretext}>Alternatives</Text>


          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>• Use any cut of pork that you prefer</Text>
            <Text style={styles.ingredients}>• Add Onions</Text>
            <Text style={styles.ingredients}>• Adding a teaspoon of sugar</Text>
