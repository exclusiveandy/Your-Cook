...
export default class Sinigang extends React.Component {
  ...
  modal9 = () => {
    ...
    this.setState({ modalVisible9: true });   
    PlaySound('my_file_name.mp3');    
    this.setState({isTimerStart: false,resetTimer: true});
  }
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalFact} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          ...
          <View style={{position: 'absolute', top: 30,}}>
              ...
              <Text> {"\n"}</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Calories: 799 kcal</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Carbohydrates: 3g</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Protein: 15g</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Fat: 80g</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Saturated Fat: 29g</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Cholesterol: 108mg</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Sodium: 856mg</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Potassium: 383mg</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Sugar: 1g</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Vitamin A: 0.7%</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Vitamin C: 8%</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Calcium: 3.3%</Text>
                <Text style={{ fontSize: 14, color: 'black' }}> Iron: 5.4%</Text>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.textDesc}>Cook Time{"\t\t"}- 1hr 30mins</Text>
          </View>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 2 lbs. pork belly sliced into cubes</Text>
            <Text style={styles.ingredients}>• 2 to 3 cups kangkong leaves</Text>
            <Text style={styles.ingredients}>• 3 pieces long green chili pepper siling pansigang</Text>
            <Text style={styles.ingredients}>• 2 pieces tomato quartered</Text>
            <Text style={styles.ingredients}>• 1 cup sliced daikon radish labanos</Text>
            <Text style={styles.ingredients}>• 10 to 12 pieces snake beans cut in 2 inch length pieces</Text>
            <Text style={styles.ingredients}>• 1 piece onion quartered</Text>
            <Text style={styles.ingredients}>• 15 pieces okra</Text>
            <Text style={styles.ingredients}>• 2 pieces taro peeled and cut in half (gabi)</Text>
            <Text style={styles.ingredients}>• 8 cups water</Text>
            <Text style={styles.ingredients}>• 2 packs Knorr Sinigang sa Sampaloc Mix Original (20 gram pack)</Text>
            <Text style={styles.ingredients}>• 3 tablespoons fish sauce patis</Text>
            <Text style={styles.ingredients}>• ¼ teaspoon ground black pepper</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. Pour water into a cooking pot. Let boil</Text>
            <Text style={styles.ingredients}>2. Add onion and tomato. Boil for 5 to 8 minutes.</Text>
            <Text style={styles.ingredients}>3. Put the pork in the cooking pot. Boil for 25 minutes.</Text>
            <Text style={styles.ingredients}>4. Add the taro. Cover and continue to boil for 30 minutes.</Text>
            <Text style={styles.ingredients}>5. Add Knorr Sinigang sa Sampaloc mix, fish sauce, and ground black pepper; stir.</Text>
            <Text style={styles.ingredients}>6. Put the daikon radish in. Cook for 3 to 5 minutes.</Text>
            <Text style={styles.ingredients}>7. Add the chili peppers, okra, and snake beans. Cook for 7 minutes.</Text>
            <Text style={styles.ingredients}>8. Add the kangkong. Cover the cooking pot and turn off the heat. Let it stay covered for 5 minutes.</Text>
            <Text style={styles.ingredients}>9. Transfer to as serving bowl. Serve with a small bowl with patis and spicy chili. Serve!</Text>
          ...
          <View style={styles.modal}>
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <TouchableOpacity onPress={this.modal9}>
                  <Text style={{ fontSize: 20, marginTop: 10 }}>NEXT</Text>
                </TouchableOpacity>
  ...
  {/* MODAL 9 */}
  <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalVisible9} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          <View style={styles.modal}>
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                <Timer
                  totalDuration={this.state.duration9} msecs
                  //Time Duration
                  start={this.state.isTimerStart}
                  //To start                  //To reset
                  //options for the styling
