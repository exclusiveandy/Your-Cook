...
import pinakbet from '../../images/vegie/pinakbet.png'
...
export default class Pinakbet extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <Modal style={styles.mainBack} animationType="slide" transparent={true} visible={this.state.modalFact} onRequestClose={() => { Alert.alert('Modal has been closed.'); }}>
          <View style={styles.modal}>
            <View style={{ position: 'absolute', top: 30, }}>
              ...
              <Text> {"\n"}</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Calories: 1243 kcal</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Carbohydrates: 28g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Protein: 5g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Fat: 124g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Saturated Fat: 45g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Cholesterol: 136mg</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Sodium: 362mg</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Potassium: 895mg</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Fiber: 7g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Sugar: 9g</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Vitamin A: 126.6%</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Vitamin C: 49.6%</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Calcium: 8.2%</Text>
              <Text style={{ fontSize: 14, color: 'black' }}> Iron: 8.3%</Text>
        ...
        <View style={{ marginTop: 20, }}>
          <TouchableOpacity onPress={this.modalfacts}>
            <Image source={pinakbet} style={styles.btnBord} />
          </TouchableOpacity>
        </View>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 1 lb lechon kawali sliced</Text>
            <Text style={styles.ingredients}>• 1 piece Knorr Shrimp Cube</Text>
            <Text style={styles.ingredients}>• 12 pieces sitaw cut into 2 inch length</Text>
            <Text style={styles.ingredients}>• 1/2 piece kalabasa cubed</Text>
            <Text style={styles.ingredients}>• 12 pieces okra</Text>
            <Text style={styles.ingredients}>• 1 piece Chinese eggplant sliced</Text>
            <Text style={styles.ingredients}>• 1 piece ampalaya sliced</Text>
            <Text style={styles.ingredients}>• 1 piece kamote cubed (optional)</Text>
            <Text style={styles.ingredients}>• 2 pieces tomato cubed</Text>
            <Text style={styles.ingredients}>• 2 thumbs ginger crushed (optional)</Text>
            <Text style={styles.ingredients}>• 1 piece onion chopped</Text>
            <Text style={styles.ingredients}>• 4 cloves garlic crushed</Text>
            <Text style={styles.ingredients}>• 2 teaspoons bagoong alamang</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. Heat cooking oil in a pot. Saute onion and garlic. Add ginger and continue to cook until the onion softens.</Text>
            <Text style={styles.ingredients}>2. Add lechon kawali. Saute for 1 minute then pour water. Let boil</Text>
            <Text style={styles.ingredients}>3. Add Knorr Shrimp Cube. Cover the pot and cook in medium heat for 20 minutes.</Text>
            <Text style={styles.ingredients}>4. Add tomato and bagoong alamang. Stir. Cover the pot. Cook for 3 minutes.</Text>
            <Text style={styles.ingredients}>5. Put the kalabasa and kamote into the pot. Cook for 7 minutes.</Text>
            <Text style={styles.ingredients}>6. Add sitaw, okra, ampalaya, and eggplant. Stir. Cover the pot and cook for 5 minutes.</Text>
            <Text style={styles.ingredients}>7. Season with ground black pepper and add remaining lechon kawali. Cook for minutes. Serve!</Text>
          ...
          <View style={styles.modal}>
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                Add lechon kawali. Saute for 1 minute then pour water. Let boil
                </Text>
