...
export default class Bihon extends React.Component {
      ...
      <ImageBackground source={backimg} style={styles.mainBack}>
        ...
        <ScrollView styles={{ marginTop: 50, }}>
          ...
          <View style={{ marginTop: 10 }}>
            <Text style={styles.ingredients}>• 1 lb pancit bihon Rice Noodles</Text>
            <Text style={styles.ingredients}>• 1/2 lb. pork cut into small thin slices</Text>
            <Text style={styles.ingredients}>• 1/2 lb. chicken cooked, deboned, and cut into thin slices</Text>
            <Text style={styles.ingredients}>• 1/8 lb. pea pods or snow pea</Text>
            <Text style={styles.ingredients}>• 1 cup carrot</Text>
            <Text style={styles.ingredients}>• 1/2 small cabbage chopped</Text>
            <Text style={styles.ingredients}>• 1 cup celery leaves chopped finely</Text>
            <Text style={styles.ingredients}>• 1 medium sized onion chopped</Text>
            <Text style={styles.ingredients}>• 1/2 tbsp garlic minced</Text>
            <Text style={styles.ingredients}>• 1 pc chicken cube</Text>
            <Text style={styles.ingredients}>• 5 tbsp soy sauce</Text>
            <Text style={styles.ingredients}>• 3 to 4 cups water</Text>
          ...
          <View style={{ marginTop: 10, flexWrap: 'wrap'}}>
            <Text style={styles.ingredients}>1. In a large pot, Saute the garlic and onion then Add the pork and chicken then let cook for 2 minutes</Text>
            <Text style={styles.ingredients}>2. Add the chicken cube and water then simmer for 15 minutes</Text>
            <Text style={styles.ingredients}>3. Put in the carrots, pea pod, cabbage, and celery leaves and simmer for a few minutes</Text>
            <Text style={styles.ingredients}>4. Remove all the ingredients in the pot except for the liquid and set them aside</Text>
            <Text style={styles.ingredients}>5. In the pot with the liquid in, add the soy sauce and mix well</Text>
            <Text style={styles.ingredients}>6. Add the pancit bihon (makes sure to first soak it in water for about 10 minutes) and mix well. Cook until liquid evaporates completely</Text>
            <Text style={styles.ingredients}>7. Put-in the vegetables and meat that were previously cooked and simmer for a minute or two</Text>
          </View>
          ...
          <View style={styles.modal}>
            <View style={{ width: 300, flex: 1, padding: 30 }}>
              ...
              <View style={{ marginTop: 32, alignItems: 'center', justifyContent: 'center' }}>
                ...
                In a large pot, Saute the garlic and onion then Add the pork and chicken then let cook for 2 minutes
                </Text>
